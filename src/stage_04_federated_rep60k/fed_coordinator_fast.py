...
# System Paths (Decoupled Fast Track)
ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
PROCESSED_DIR = os.path.join(ROOT_DIR, "data", "processed")
CLIENTS_DIR = os.path.join(PROCESSED_DIR, "clients_rep_60k")
CACHE_TOKENIZED_DIR = os.path.join(ROOT_DIR, "data", "interim", "stage_04_tokenized_rep60k")
...
REPORTS_DIR = os.path.join(ROOT_DIR, "reports", "stage_04_federated_rep60k")
...
def load_client_loaders(batch_size=256):
    train_loaders = {}
    val_loaders = {}
